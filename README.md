...
- [ ] **GitHub Actions** `0%`
  - [ ] Workflow: `lint.yml` — ruff, black (backend), eslint, tsc (frontend)
  - [ ] Workflow: `test.yml` — pytest with PostGIS, Jest for frontend
  - [ ] Workflow: `security.yml` — bandit (Python), Trivy (Docker image)
